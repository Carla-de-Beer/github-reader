...
public class ReaderServiceImpl implements ReaderService {
    ...
    public JsonArray getJsonArrayRepos(String userName) {
        ...
        JsonElement root = ReaderServiceImpl.readURL(sURL);
        assert root != null;
    ...
    public User getUser(String userNameInput) {
        ...
        JsonElement element = ReaderServiceImpl.readURL(sURL);
        ...
        return User.builder()
                ...
                .numFollowers(ReaderServiceImpl.getNumFollowers(userNameInput))
                .build();
    }
